<template>
  <div>
    ...
    <TheInstruction />
      ...
      <iframe width="800" height="480" src="https://www.youtube.com/embed/Z3A4t4CNSOY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    return {
      ...
      triggers: [
        ...
        },
        {
          title: "Чат трейдеров",
          about:
            "Общение, обмен опытом в отдельной приватной группе. Каждый человек в чате - начинающий или опытный трейдер, что делает его ценным ресурсом для профессионального роста.",
        },
        {
